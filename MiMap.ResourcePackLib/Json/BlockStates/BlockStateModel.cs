...
namespace MiMap.ResourcePackLib.Json.BlockStates
{
	public class BlockStateModel
	{
		...
		/// <summary>
		/// Can be true or false (default). Locks the rotation of the texture of a block, if set to true. This way the texture will not rotate with the block when using the x and y-tags above.
		/// </summary>
