...
namespace MiMap.GeneratorPlugin
{
    [Plugin(PluginName = "MiMap.Generator")]
    public class MiMapGeneratorPlugin : Plugin
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(MiMapGeneratorPlugin));
